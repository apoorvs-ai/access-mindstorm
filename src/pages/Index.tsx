        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            ...
            <div className="border rounded-md overflow-hidden">
              {/* Table Header */}
              <div className="grid grid-cols-5 bg-slate-600 text-white p-3">
                <div className="font-medium flex items-center">
                  Name 
                  <ChevronRight className="h-4 w-4 ml-1" />
                </div>
                <div className="font-medium">System Groups</div>
                <div className="font-medium flex items-center">
                  Type
              ...
              <div className="p-3 bg-white border-t flex justify-between items-center text-sm">
                <span className="text-gray-600">Showing 0 to 0 of 0</span>
